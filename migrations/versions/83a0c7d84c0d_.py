...
Revision ID: 83a0c7d84c0d
Revises: 
Create Date: 2022-06-18 02:00:27.697468
...
def upgrade():
    ...
    sa.Column('hora_entrega', sa.String(length=20), nullable=True),
    ...
    sa.Column('estado', sa.Boolean(), nullable=False),
    sa.Column('comuna_id', sa.Integer(), nullable=False),
    sa.Column('constraseña', sa.String(length=250), nullable=False),
